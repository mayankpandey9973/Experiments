...
tf.app.flags.DEFINE_string('eval_dir', HOME + '/tfRuns/outputs/' + cifar10.name + 'eval',
                           """Directory where to write event logs.""")
tf.app.flags.DEFINE_string('eval_data', 'test',
                           """Either 'test' or 'train_eval'.""")
tf.app.flags.DEFINE_string('checkpoint_dir', HOME + '/tfRuns/outputs/' + cifar10.name + 'train',
...
def evaluate():
  ...
  with tf.Graph().as_default() as g:
    ...
    # inference model.
    logits = cifar10.inference(images, cifar10.N, use_batchnorm=True, 
