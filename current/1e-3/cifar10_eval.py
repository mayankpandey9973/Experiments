...
tf.app.flags.DEFINE_string('eval_dir', '/home/mayankp/tfRuns/outputs/normalized_relu/tmp/eval-' + str(cifar10.SCALE) + '_n_' + str(n) + '_1meanSqrtFilter',
                           """Directory where to write event logs.""")
tf.app.flags.DEFINE_string('eval_data', 'test',
                           """Either 'test' or 'train_eval'.""")
tf.app.flags.DEFINE_string('checkpoint_dir', '/home/mayankp/tfRuns/outputs/normalized_relu/tmp/trainL2-' + str(cifar10.SCALE) + '_n_' + str(n) + '_1meanSqrtFilter', 
