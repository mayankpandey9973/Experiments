...
tf.app.flags.DEFINE_string('eval_dir', '~/tfRuns/outputs/normalized_relu/tmp/eval',
                           """Directory where to write event logs.""")
tf.app.flags.DEFINE_string('eval_data', 'test',
                           """Either 'test' or 'train_eval'.""")
tf.app.flags.DEFINE_string('checkpoint_dir', '~/tfRuns/outputs/normalized_relu/tmp/train',
