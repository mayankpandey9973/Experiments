...
# from tensorflow.models.image.cifar100 import cifar100
import cifar100
...
tf.app.flags.DEFINE_string('train_dir',
	'/home/mayankp/tfRuns/outputs/normalized_relu/tmp/trainL2-' + cifar100.name,
...
def train():
  ...
  with tf.Graph().as_default():
    ...
    # images, labels = cifar100.standard_distorted_inputs()
    inputs = cifar100.ram_inputs(unit_variance=True, is_train=True)
